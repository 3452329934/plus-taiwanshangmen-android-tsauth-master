...
public class BaseRewardRepository implements IRewardRepository {
    ...
    @Override
    public Observable<Object> rewardUser(long user_id, double amount,String psd) {
        return mUserInfoClient.rewardUser(user_id, (long) amount,psd)
     ...
     */
    @Override
    public Observable<Object> rewardInfo(long news_id, double amount,String psd) {
        return mInfoMainClient.rewardInfo(news_id, (long) amount,psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
     ...
     */
    @Override
    public Observable<Object> rewardDynamic(long feed_id, double amount,String psd) {
        return mDynamicClient.rewardDynamic(feed_id, (long) amount,psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
     ...
     */
    @Override
    public Observable<Object> rewardQA(long answer_id, double amount,String psd) {
        return mQAClient.rewardQA(answer_id, (long) amount,psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
    ...
    @Override
    public Observable<Object> rewardPost(long postId, double rewardMoney,String psd) {
        return mCircleClient.rewardPost(postId, (long) rewardMoney,psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
