                        ...
                        if (jsonObject.has("images")) {
                            ...
                            if (jsonArray.length() > 0) {
                                if (jsonArray.getJSONObject(0).has("file")) {
                                    source_cover = (long) jsonArray.getJSONObject(0).getDouble("file");
                                } else if (jsonArray.getJSONObject(0).has("id")) {
                ...
                case APP_LIKE_GROUP_POST:
                    ...
                    if (jsonObject2.has("images")) {
                        ...
                        if (jsonArray2.getJSONObject(0).has("file")) {
                            source_cover = (long) jsonArray2.getJSONObject(0).getDouble("file");
                        } else if (jsonArray2.getJSONObject(0).has("id")) {
