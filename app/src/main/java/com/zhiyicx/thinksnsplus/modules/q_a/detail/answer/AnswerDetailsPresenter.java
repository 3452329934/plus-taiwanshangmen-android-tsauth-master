...
import static com.zhiyicx.thinksnsplus.config.EventBusTagConfig.EVENT_ADOPT_ANSWER;
        ...
        Subscription subscription = mBaseQARepository.adoptionAnswer(question_id, answer_id)
                ...
                .subscribe(new BaseSubscribeForV2<BaseJsonV2<Object>>() {
                    ...
                    protected void onSuccess(BaseJsonV2<Object> data) {
                        ...
                        mRootView.setAdopt(true);
                        EventBus.getDefault().post(mRootView.getAnswerInfo(), EVENT_ADOPT_ANSWER);
                    }
