...
public class RewardListAdapter extends CommonAdapter<RewardsListBean> {
    ...
    private void setItemData(final ViewHolder holder, final RewardsListBean rewardsListBean, final int position) {
        ...
        // 设置用户信息
        UserInfoBean userInfoBean = rewardsListBean.getUser();
        String userName;
        if (userInfoBean == null) {
            // 这种情况一般不会发生，为了防止崩溃，做处理
            userInfoBean = new UserInfoBean();
            userInfoBean.setUser_id(rewardsListBean.getUser_id());
            userName = getContext().getString(R.string.default_delete_user_name);
        }else {
        ...
        switch (mRewardType) {
            case INFO:
                result = getContext().getResources().getString(R.string.reward_list_tip, "<" + userName + ">");
                break;
            case DYNAMIC:
                result = getContext().getResources().getString(R.string.reward_list_tip_dynamic, "<" + userName + ">");
                break;
            case USER:
                result = getContext().getResources().getString(R.string.reward_list_tip_user, "<" + userName + ">");
                break;
            case QA_ANSWER:
                result = getContext().getResources().getString(R.string.reward_list_tip_answer, "<" + userName + ">");
                break;
            default:
                result = getContext().getResources().getString(R.string.reward_list_tip, "<" + userName + ">");
        ...
        RxView.clicks(holder.getView(R.id.iv_headpic))
                ...
                .subscribe(aVoid -> toUserCenter(getContext(), finalUserInfoBean));
