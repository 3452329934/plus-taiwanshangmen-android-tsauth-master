...
public class MessageLikePresenter extends AppBasePresenter<MessageLikeContract.View> implements MessageLikeContract.Presenter {
    ...
    public void requestNetData(Long maxId, final boolean isLoadMore) {
        Subscription commentSub = mNotificationRepository.makeNotificationReaded(INotificationRepository.LIKE)
                .observeOn(Schedulers.io())
                .flatMap((Func1<Object, Observable<List<DigedBean>>>) o -> mBaseDynamicRepository.getLikeMessages(INotificationRepository.LIKE,
                        maxId.intValue()))
