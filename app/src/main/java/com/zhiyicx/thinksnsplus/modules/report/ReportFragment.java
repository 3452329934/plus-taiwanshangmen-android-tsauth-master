    ...
    private void updateData() {
        switch (mReportResourceBean.getType()) {
            ...
            case USER:
                ...
                break;
            case TOPIC:
                mTvTitle.setText(getString(R.string.report_title_format, mReportResourceBean.getUser().getName(), getString(R.string.topic)));
                break;
            default:
        }
        // title 点击
        ...
        if (!TextUtils.isEmpty(mReportResourceBean.getUser().getName())) {
            Link link = new Link(mReportResourceBean.getUser().getName())
                    ...
                    .setOnClickListener((clickedText, linkMetadata) -> {
                        PersonalCenterFragment.startToPersonalCenter(mActivity, mReportResourceBean.getUser());
//                        goDetail();
                    });
            links.add(link);
        }
