...
public class RechargeFragment extends TSFragment<RechargeContract.Presenter> implements RechargeContract.View {
    ...
    private void initRechargeLables() {
        ...
        mRechargeLables = mSystemConfigBean.getWallet().getLabels();
    ...
    private void initPayStylePop() {
        ...
        if (mSystemConfigBean.getWallet().getRecharge()!= null&&mSystemConfigBean.getWallet().getRecharge().getTypes()!=null) {
            rechargeTypes.addAll(Arrays.asList(mSystemConfigBean.getWallet().getRecharge().getTypes()));
        }
