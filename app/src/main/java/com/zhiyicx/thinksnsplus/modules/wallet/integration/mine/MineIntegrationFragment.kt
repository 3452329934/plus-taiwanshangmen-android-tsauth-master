...
class MineIntegrationFragment : TSFragment<MineIntegrationContract.Presenter>(), MineIntegrationContract.View {
    ...
    override fun initView(rootView: View) {
        ...
        if (mSystemConfigBean == null || mSystemConfigBean.currency.recharge == null || !mSystemConfigBean.currency.recharge.isOpen) {
            mBtReCharge.visibility = View.GONE
        } else {
            mBtReCharge.visibility = View.VISIBLE
        }
        if (mSystemConfigBean == null || mSystemConfigBean.currency.cash == null || !mSystemConfigBean.currency.cash.isOpen) {
