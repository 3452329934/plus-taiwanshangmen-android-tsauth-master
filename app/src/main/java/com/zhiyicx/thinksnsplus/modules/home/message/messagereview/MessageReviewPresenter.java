...
public class MessageReviewPresenter extends AppBasePresenter<
    ...
    public void requestNetData(Long maxId, final boolean isLoadMore) {
        ...
        String clearMessageCountType = "";
        switch (mRootView.getType()) {
            case TOP_DYNAMIC_COMMENT:
                clearMessageCountType = UserFollowerCountBean.UserBean.MESSAGE_TYPE_FEED_COMMENT_PINNED;
                observable = mMessageReviewRepository.getDynamicReviewComment(maxId.intValue());
                break;
            case TOP_NEWS_COMMENT:
                clearMessageCountType = UserFollowerCountBean.UserBean.MESSAGE_TYPE_NEWS_COMMENT_PINNED;
                observable = mMessageReviewRepository.getNewsReviewComment(maxId.intValue());
                break;
            case TOP_POST_COMMENT:
                clearMessageCountType = UserFollowerCountBean.UserBean.MESSAGE_TYPE_POST_COMMENT_PINNED;
                observable = mMessageReviewRepository.getPostReviewComment(maxId.intValue());
                break;
            case TOP_CIRCLE_MEMBER:
                clearMessageCountType = UserFollowerCountBean.UserBean.MESSAGE_TYPE_GROUP_JOIN_PINNED;
                observable = mMessageReviewRepository.getCircleJoinRequest(maxId.intValue());
                break;
            case TOP_POST:
                clearMessageCountType = UserFollowerCountBean.UserBean.MESSAGE_TYPE_POST_PINNED;
        ...
        mUserInfoRepository.clearUserMessageCount(clearMessageCountType)
