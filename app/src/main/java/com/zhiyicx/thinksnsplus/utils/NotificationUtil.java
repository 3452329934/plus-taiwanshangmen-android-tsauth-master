...
public class NotificationUtil {
    ...
    public void showNormalNotification(String content) {
        ...
        setCellPhoneUnreadCount(notification);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(content,
                    "new message",
    ...
    public void postNotification(JpushMessageBean jpushMessageBean) {
        ...
        notification.flags = Notification.FLAG_AUTO_CANCEL;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(jpushMessageBean.getMessage(),
                    "new message",
                    NotificationManager.IMPORTANCE_DEFAULT);
            notificationManager.createNotificationChannel(channel);
        }
    ...
    public void postChatNotification(JpushMessageBean jpushMessageBean, String chatId) {
        ...
        notification.flags = Notification.FLAG_AUTO_CANCEL;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(chatId,
                    "new message",
                    NotificationManager.IMPORTANCE_DEFAULT);
            notificationManager.createNotificationChannel(channel);
        }
    ...
    private void setCellPhoneUnreadCount(Notification notification) {
        BadgeNumberManager.from(context).setBadgeNumber(notification,TSEMHyphenate.getInstance().getMsgUnreadCount());
    }
