...
//        System.out.println("test2 = " + test2.size());
    ...
    public void testNetErrorResponseMessage() {
        ...
        String response5 = "{\n" +
                ...
                "            \"line\": 149,\n" +
                "            \"function\": \"handle\",\n" +
                "            \"class\": \"Fideloper\\\\GifProxy\\\\TrustProxies\",\n" +
                "            \"type\": \"->\",\n" +
                "            \"args\": [\n" +
                "                {\n" +
                "                    \"attributes\": {},\n" +
...
//        }
    ...
    public void testnewArray() {
        ...
        List<Integer> tmp2 = new ArrayList<>(tmp1);
        tmp1.clear();
        Assert.assertTrue(tmp2.size() > 0);

    }

    @Test
    public void testUrl() {
        String url = "http://ximage.zhibocloud.cn/2018/09/06/cXy9V3b4aRo3JoWg1ISR5EvXR9xPE3eeeJgCKRLjAi0m7ABDCWC4se7e89qRBTQ5.jpg?OSSAccessKeyId=LTAIXfwTSAa2RTVn&Expires=1536231255&Signature=NIoQ4TUgLtuD%2FBBI%2BRO9mZRJrU0%3D";
        try {
    ...
    @Test
    public void testAdvertUrl() {
        String url = "https://tsplus.zhibocloud.cn/h5/news/482?jxytime=1551687578692";
        String matcher = "https://tsplus.zhibocloud.cn/.*?news/(\\d+).*";
        Matcher advert = Pattern.compile(matcher).matcher(url);
        while (advert.find()) {
            System.out.println("size" + advert.groupCount());
            System.out.println("0" + advert.group(0));
            System.out.println("1" + advert.group(1));
        }
