...
-keep class com.hyphenate.chatuidemo.utils.EaseSmileUtils {*;}
...
-keep class com.zhiyicx.thinksnsplus.jpush.MyMiPushReciver {*;}
-keep class com.zhiyicx.thinksnsplus.jpush.My2HuaWeiPushReceiver {*;}
-keep class com.zhiyicx.thinksnsplus.jpush.MyHuaWeiPushReceiver {*;}
-keep class com.zhiyicx.thinksnsplus.jpush.JpushReceiver {*;}
#----------------------------------------------------------------------------
#--