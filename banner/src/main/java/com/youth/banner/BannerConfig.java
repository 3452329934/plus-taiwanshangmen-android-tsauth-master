...
public class BannerConfig {
    ...
    public static final int NUM_INDICATOR_FOR_GOODS = 6;
    ...
    public static final boolean IS_NEED_LOOP = true;
    public static final boolean IS_AUTO_PLAY = true;
    public static final boolean IS_BASE64_IMAGE = false;
    public static final boolean IS_SCROLL = true;
    public static final boolean IS_ENABLE_SCROLL = true;
    public static final boolean IS_DONW_STOP_UP_AUTO_PLAY = true;
